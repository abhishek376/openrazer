...
class BaseRazerFX(object):
    def __init__(self, serial, capabilities, daemon_dbus=None):
...
class RazerFX(BaseRazerFX):
    def __init__(self, serial, capabilities, daemon_dbus=None, matrix_dims=(-1, -1)):
    ...
    def static(self, red, green, blue):
        """
        Wave effect
    ...
    def reactive(self, red, green, blue, time):
        """
        Reactive effect
    ...
    def breath_single(self, red, green, blue):
        """
    ...
    def ripple(self, red, green, blue, refreshrate = c.RIPPLE_REFRESH_RATE):
        """
    ...
    def ripple_random(self, refreshrate = c.RIPPLE_REFRESH_RATE):
        """
    ...
    def starlight_single(self, red, green, blue, time):
        """
        Starlight effect
    ...
    def starlight_random(self, time):
        """
        Starlight effect
...
class SingleLed(BaseRazerFX):
    def __init__(self, serial, capabilities, daemon_dbus=None, led_name='logo'):
    ...
    def blinking(self, red, green, blue):
        if not isinstance(red, int):
            raise ValueError("Red is not an integer")
        if not isinstance(green, int):
            raise ValueError("Green is not an integer")
    ...
    def pulsate(self, red, green, blue):
        if not isinstance(red, int):
            raise ValueError("Red is not an integer")
        if not isinstance(green, int):
            raise ValueError("Green is not an integer")
