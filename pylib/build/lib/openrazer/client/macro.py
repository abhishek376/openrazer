...
class RazerMacro(object):
    def __init__(self, serial, devname, daemon_dbus=None, capabilities=None):
    ...
    def add_macro(self, bind_key, macro_object_sequence):
        """
    ...
    @staticmethod
    def create_script_macro_item(script_path, script_args = None):
        """
    ...
    @staticmethod
    def create_keypress_up_macro_item(key_name, pre_pause = 0):
        """
    ...
    @staticmethod
    def create_keypress_down_macro_item(key_name, pre_pause = 0):
        """
    ...
    @classmethod
    def create_keypress_macro_item(cls, key_name, pre_pause = 0):
        """
